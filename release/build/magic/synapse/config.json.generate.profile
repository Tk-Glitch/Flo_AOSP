    ...
    elements:[
		{ STitleBar:{
			...
			{ SOptionList:{
				...
				default:"None",
				values:[ "None",
					`for BAK in \`$SYN/actions/restorebackup listprofile\`; do
						echo "\"$BAK\","
					done`
				],
				notify:[
		...
		{ SPane:{
			...
			{ SOptionList:{
				...
				default:"None",
				values:[ "None",
					`for BAK in \`$SYN/actions/restorebackup listconfig\`; do
						echo "\"$BAK\","
					done`
				],
				notify:[
		...
		{ SPane:{
			...
			{ SGeneric:{
				...
				default:"None",
				action:"generic $SYN/files/bck_prof",
			}},
			{ SDescription:{
